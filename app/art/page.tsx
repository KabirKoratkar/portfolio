      ...
      <div className="mt-16 grid gap-px border border-border bg-border sm:grid-cols-2 lg:grid-cols-3">
        {pieces.map((piece, i) => (
          <Reveal key={piece.id} delay={(i % 3) * 100}>
            <div className="group relative flex aspect-[4/5] flex-col justify-between overflow-hidden bg-background p-4 transition-transform duration-300 hover:-translate-y-1">
